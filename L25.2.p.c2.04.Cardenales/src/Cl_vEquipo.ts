...
export default class Cl_vEquipo extends Cl_vGeneral {
    private _vCriollo: Cl_vCriollo;
    private _vImportado: Cl_vImportado;
    private dataJugadores: HTMLElement;
    private lblPromedioMensualImportado: HTMLElement;
    private btAgregarCriollo: HTMLButtonElement;
    private btAgregarImportado: HTMLButtonElement;
    ...
    reportarJugador({
        ...
        dataJugadores: iJugador;
        promedioMensualImportado: number;
    }): void {
        this.dataJugadores.innerHTML += `
        <tr>
