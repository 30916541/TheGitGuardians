...
export default class Cl_vLibreria extends Cl_vGeneral {
    ...
    _vLibroAdolescente;
    dataLibros;
    lblTotalLibrosIlustrados;
    lblTotalIlustrados;
    lblPrecioPromedioIlustrados;
    lblLibrosMayor100;
    lblCantidadLibros;
    lblPorcentajeLibrosMayor100;
    btAgregarLibroNino;
    btAgregarLibroAdolecente;
    constructor() {
    ...
    reportarLibro({ dataLibros, totalLibrosIlustrados, TotalIlustrados, precioPromedioIlustrados, LibrosMayor100, CantidadLibros, PorcentajeLibrosMayor100, }) {
        this.dataLibros.innerHTML += `
            <tr>
